            ...
            return (
              ...
              >
                <span
                  ...
                  style={{ background: `linear-gradient(135deg, ${theme.preview[0]} 20%, ${theme.preview[1]} 55%, ${theme.preview[2]})` }}
                  aria-hidden="true"
                />
                <span className="min-w-0 text-left">
                  <span className="block text-sm font-semibold text-main">{theme.label}</span>
                  <span className="mt-0.5 block text-xs leading-5 text-muted">{theme.description}</span>
                </span>
