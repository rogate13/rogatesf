...
export const experiences: Experience[] = [
  {
    ...
    summary:
      "Teach programming and computational thinking through interactive learning sessions, guide student projects, and adapt technical explanations to different skill levels.",
    responsibilities: [
      "Programming and computational thinking instruction",
      "Project mentoring and coding exercises",
  ...
  },
  {
    ...
    period: "Feb 2026 - Apr 2026",
    summary:
      "Supported collector operations and SiMobile users while processing RAW and Masking data, preparing performance reports, monitoring visit validation, and supporting month-end data preparation.",
    responsibilities: [
      "Collector check-in and attendance monitoring",
      "MCD / SiMobile user support",
      "RAW and Masking data processing",
      "Collector performance and visit analysis",
      "DB SiMobile and attendance reporting",
      "Month-end data preparation",
    ],
  ...
  },
  {
    ...
    period: "Apr 2025 - Dec 2025",
    summary:
      "Developed and maintained web applications while supporting business requirements, database performance, website maintenance, backend improvements, and technical needs.",
    responsibilities: [
  ...
  },
  {
    ...
    period: "Jul 2024 - Mar 2025",
    summary:
      "Maintained web applications, troubleshot system issues, supported hardware and software, developed internal applications, and helped improve workflow automation and daily IT operations.",
    responsibilities: [
      "Web application maintenance",
      "System and IT troubleshooting",
  ...
  },
  {
    ...
    summary:
      "Handled internal technical support across software, hardware, system configuration, user assistance, application issues, bug reporting, and support documentation.",
    responsibilities: [
      "Technical and system support",
      "Software installation and configuration",
      "User support and basic training",
      "Bug reporting and application support",
  ...
  },
  {
    ...
    summary:
      "Maintained professional-certification information systems and supported salary data, invoice planning, cash flow, attendance, administrative processes, internal system improvements, and users.",
    responsibilities: [
      "Information system maintenance",
      "Administrative system support",
      "Salary, invoice, cash-flow, and attendance data support",
